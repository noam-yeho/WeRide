[x]() First look of the app will be the map.
[x] All the login and convoys in the side of the map and all the feature features, that will not intterapt to the user view.
